...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        await conn.sendMessage(from, { image: { url: data.message }, caption: '> *© ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝙻ιzα мωσℓ ' }, { quoted: mek });
    } catch (e) {
        console.log(e); // ❯❯ Powered by LIZAMWOL 👑
...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        await conn.sendMessage(from, { image: { url: data[0].url }, caption: 'LIZAMWOL-MD DOWNLOAD CAT 🐈 PICS\n\n> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝙻ιzα мωσℓ*' }, { quoted: mek });
    } catch (e) {
        console.log(e);
